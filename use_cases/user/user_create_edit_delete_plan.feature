...
#	When User creates plan with name "Eksamens Projekt 1", with start date "11-03-2019" and time 
# 		"15:00" and end date "05-05-2019" and time "23:59", with participants "Jonathan Winther", "Nicholas Dyhre", 
# 		"Marcus Kristensen" og "Sebastian Vestrup"
#	Then Plan is created with the participants and they are notified.
#	
#Scenario: Edits plan successfully
#	Given User is logged in
#	And Plan exists with parameters name "Eksamens Projekt 1", with start date "11-03-2019" and time 
		#"15:00" and end date "05-05-2019" and time "23:59", with participants "Jonathan Winther", "Nicholas Dyhre", 
		#"Marcus Kristensen" og "Sebastian Vestrup"
